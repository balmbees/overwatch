...
import CloudwatchAlarmWatcherSchema from '../../server/models/watcher/polymorphs/cloudwatch_alarm_watcher_schema.json';

function CloudwatchAlarmWatcherForm() {
  return (
    <Form
      schema={CloudwatchAlarmWatcherSchema}
      onSubmit={
        (data) => $.post('/api/cypher', {
          node: {
            label: ComponentSchema.title,
